...
varParam = [
    ['name', 's', 'Bending Magnet Radiation', 'simulation name'],

#---Data Folder
    ['fdir', 's', 'Bending_Magnet_Radiation/', 'folder (directory) name for reading-in input and saving output data files'],
...
#---Electron Beam
    ...
    ['ebm_betax', 'f', 1.5, 'horizontal beta-function [m]'],
    ['ebm_betay', 'f', 22.5, 'vertical beta-function [m]'],
    ['ebm_alphax', 'f', 0.0, 'horizontal alpha-function [rad]'],
    ['ebm_alphay', 'f', -0.9, 'vertical alpha-function [rad]'],
    ['ebm_etax', 'f', 0.137, 'horizontal dispersion function [m]'],
    ['ebm_etay', 'f', 0.0, 'vertical dispersion function [m]'],
    ['ebm_etaxp', 'f', -0.1, 'horizontal dispersion function derivative [rad]'],
    ['ebm_etayp', 'f', 0.0, 'vertical dispersion function derivative [rad]'],

# Beam parameter needed by all source types
    ['ebm_z', 'f', 0., 'electron beam initial average longitudinal position [m]'],
    ['mag_ior','f', 1.0, 'interpolation order to use for tabulated magnetic field (1<= mag_ior <= 3)'],
    ['mag_zc','f', 0.0, 'center longitudinal position [m]'],
    ['mag_fn','s', 'ivu21_srx_g6_2c.dat', 'input 3D magnetic field file name'],
...
#---Calculation Types
    ...
    # Former appParam:
    ['rs_type', 's', 'a', 'source type, (u) idealized undulator, (t), tabulated undulator, (m) multipole, (g) gaussian beam'],
